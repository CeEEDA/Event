...
const DEFAULT_FIELD_MAPPINGS = {
  ...
  engine_type: true,
  engine_number: true,
  generator_manufacturer: true,
  generator_type: true,
  generator_number: true,
  notes: false,
  location: false,
  status: false,
};
...
const FIELD_LABELS = {
  ...
  model: "Modell",
  power_output: "Leistung",
  year_of_manufacture: "Baujahr",
  controller: "Steuerung",
  engine_manufacturer: "Motor-Hersteller",
  engine_type: "Motor-Typ",
  engine_number: "Motornummer",
  generator_manufacturer: "Generator-Hersteller",
  generator_type: "Generator-Typ",
  generator_number: "Generatornummer",
  notes: "Notizen",
  location: "Standort",
  status: "Status",
};
