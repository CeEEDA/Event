...
import { ArrowLeft, Receipt, ChevronDown, ChevronUp, DollarSign, Moon, Sun } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50" data-testid="abrechnung-page">
      ...
      <div className="max-w-3xl mx-auto px-4 py-5 space-y-3">
        {releases.length === 0 && (
          <p className="text-sm text-gray-400 text-center py-8" data-testid="no-releases">Noch keine freigegebenen Abrechnungen vorhanden.</p>
        )}
