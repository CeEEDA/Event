                          ...
                          <td className="px-2 py-2.5">
                            <div className="flex items-center justify-end gap-0.5">
                              <button
                                ...
                                className="p-1 rounded hover:bg-fuchsia-100 text-gray-400 hover:text-fuchsia-600 transition-colors"
                                title="Bearbeiten"
          ...
          {selectedAsset && (
            <div className="fixed inset-0 z-[9999] bg-black/50 flex items-center justify-center p-4" onClick={() => setSelectedAsset(null)} data-testid="asset-detail-modal">
              <div className="bg-white rounded-xl shadow-2xl max-w-lg w-full max-h-[90vh] flex flex-col overflow-hidden" onClick={(e) => e.stopPropagation()}>
                ...
                {/* Action-Bar unter Header: Bearbeiten */}
                <div className="flex-shrink-0 px-5 py-2 bg-fuchsia-50/60 border-b border-fuchsia-100 flex items-center justify-end">
                  <button
                    type="button"
                    onClick={() => { setEditingAsset(selectedAsset); setSelectedAsset(null); }}
                    className="inline-flex items-center gap-1.5 text-xs font-medium text-fuchsia-700 hover:text-fuchsia-900"
