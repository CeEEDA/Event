            ...
            <div className="p-5 overflow-y-auto max-h-[70vh] space-y-6 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  <li>Die angebotenen Preise sind Nettopreise und werden zuzueglich der jeweils geltenden gesetzlichen Mehrwertsteuer berechnet.</li>
                  <li>Falls in unserem Angebot oder Auftrag eine Anzahlungsaufforderung enthalten ist, beachten Sie bitte Folgendes: Ueberweisen Sie den angegebenen Betrag der Brutto-Angebots- oder Auftragssumme auf unser Konto. Unsere Kontoverbindung finden Sie auf unserem Geschaeftspapier im unteren Abschnitt. Um den Betrag zuordnen zu koennen, geben Sie bitte immer unsere Referenz Nummer an (Angebots- oder Rechnungsnummer). Eine eventuelle Rueckerstattung der Anzahlung erfolgt in der Schlussrechnung zum Mietvertrag. Selbstverstaendlich lassen wir Ihnen nach Ruecksprache im Vorfeld eine Rechnung zukommen. Bei Nichteinhaltung der Anzahlung erfolgt keine Lieferung (oder Bereitstellung fuer Selbstabholer) unseres Mietmaterials und keine Dienstleistungen. Ihr Auftrag (Bestellung) wird zu unseren weiter unten angegebenen Stornierungskosten berechnet und anschliessend von uns geschlossen.</li>
                  <li><strong>Stromverbrauch:</strong> Der aktuelle Zaehlerstand unseres geeichten Zaehler wird bei Aufbau notiert. Beim Abbau wird der neue Stand ebenfalls notiert und 1:1 an das jeweilige EVU gemeldet. Diese schreiben die Rechnung an den Kunden.</li>
                </ol>
              </div>
              ...
              <div>
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  <li>Saemtliche Anschlussarbeiten an Fremdgewerke sind vor Inbetriebnahme der Anlagen durch den Anlagenverantwortlichen des jeweiligen Fremdgewerks auf Richtigkeit zu pruefen. Unsere Installation wird eigenstaendig geprueft und freigegeben. Der Anschlusspunkt (z.B. Steckdose) ist der Uebergabepunkt zum Fremdgewerk. Fuer den ordnungsgemaessen Anschluss der Anlagen ist somit das Inbetriebsetzen Unternehmen verantwortlich. Der Potenzialausgleich in den Fremdgewerken endet mit Montage eines Uebergabepunktes. Der oertliche Potenzialausgleich wird durch das Gewerk realisiert.</li>
                </ol>
              </div>
              ...
              <div>
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  <li>Grundsaetzlich gelten fuer unsere Kalkulation nur die in Verbindung stehenden Planunterlagen, Ausschreibungen, Details, und Leistungsverzeichnisse. Darueber hinaus zur Verfuegung gestellte Plaene der Fremdgewerke sind nur informativ und finden in unserer Kalkulation keine Beruecksichtigung. Bei unserer Kalkulation sind wir davon ausgegangen, dass wir eine koordinierte Ausfuehrungsplanung erhalten, die den anerkannten Regeln und Richtlinien entspricht. Dies ist die Grundlage zur Erstellung unserer Werks- und Montageplanung.</li>
                  <li>Wir setzen voraus, dass alle Montagetaetigkeiten zuegig ohne Unterbrechung und waehrend unserer normalen Arbeitszeit Mo-Do 7:30-16:30 und Fr. 7:30 - 15:15 Uhr, ausgefuehrt werden koennen. Mehraufwand durch Montagezeiten ausserhalb dieser Zeiten werden gesondert berechnet. Wartezeiten, die nicht von uns verschuldet werden, sowie Mehraufwand durch Schwierigkeiten oder nicht kalkulierten Arbeiten, werden zusaetzlich nach tatsaechlichem Aufwand berechnet.</li>
                  <li>Etwaige Anforderungen durch das Amt fuer Immissionsschutz wurden nicht beruecksichtigt.</li>
                  <li>Unsere Kalkulation basiert auf den zurzeit gueltigen Vorschriften- und Gesetzesstand. Sollten sich diese waehrend der Projektphase aendern, so weisen wir darauf hin, dass wir dem Auftraggeber ein Angebot unterbreiten, welches wir nach entsprechender Beauftragung umsetzen werden.</li>
                </ol>
              </div>
              ...
              <div>
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  <li>Fuel-Management wird durch Eventenergie Deutschland GmbH & Co. KG durchgefuehrt, wenn nicht ausdruecklich anders vereinbart. Zum Zeitpunkt der Betankung legen wir, zur Abrechnung an den Veranstalter, den tagesaktuellen Heizoelpreis zuzueglich einer Handling-Pauschale von 35% zugrunde.</li>
                  <li><strong>Kraftstoffregelung Deutschland:</strong> Hinweis fuer Betreiber (Mieter) von Kraftstoffanlagen gemaess WHG (Wasserhaushaltsgesetz). Nach §5 Wasserhaushaltsgesetz (WHG) und §2 Abs. 9 der Anlagenverordnung (AwSV) darf keine nachteilige Veraenderung der Gewaessereigenschaften durch die Anlage (auch Miet-Anlagen) entstehen. Anlagen mit einem Tank groesser 1.001 Liter, welche laenger als ein halbes Jahr betrieben werden, sind fachbetriebspflichtig und muessen von einem Sachverstaendigen abgenommen werden. Ausserdem gehoeren diese Anlagen 6 Wochen vor dem Betrieb, der unteren Wasserbehoerde angezeigt. Die Verantwortung fuer die Einhaltung dieser Vorgaben uebernimmt der Mieter. Er verpflichtet sich evtl. Verstoesse an den Vermieter mitzuteilen.</li>
                  <li><strong>Betriebsarten / Leistungsabgabe:</strong> Standartausfuehrung zum Mietmaterial. 400V / 50 Hz fuer die Netzform TN-C-S. Aenderungen sind auf Anfrage und gegen Aufpreis moeglich. Unter Beruecksichtigung der im Angebot angegebenen Leistung (entspricht 100%) sind unsere Aggregate fuer folgende Betriebsarten/Leistungsabgaben geeignet:
                    <ul className="list-disc pl-5 mt-1 space-y-0.5">
                      ...
                      <li>Stosslasten max. 50 % der angegebenen Leistung</li>
                      <li>Schieflasten max. 20 % der angegebenen Leistung</li>
                    </ul>
                    <p className="mt-1">Alle Angaben nur waehrend des Betriebs moeglich, nicht aus dem Stand-by-Betrieb waehrend der Anlaufphase.</p>
                  </li>
                  <li>Bitte beachten Sie bei Ihrer Planung die gewuenschte Versorgungssicherheit der Mietanlage. Wenn in Ihrer Planung Aggregate zum Einsatz kommen beachten Sie bitte, dass sich in allen Aggregaten drehende, mechanische und elektronische Teile befinden. Es gibt somit keine 100 % Garantie, dass es nie zu einem Stoerfall (Ausfall) kommen kann.</li>
                  <li><strong>Folgende Planungsmoeglichkeiten bieten wir an:</strong>
                    <ul className="list-disc pl-5 mt-1 space-y-1">
                      <li><strong>Ein Single Aggregat:</strong> Im Stoerfall kann eine Versorgungsunterbrechung einen laengeren Zeitraum andauern.</li>
                      <li><strong>Zwei oder mehr Aggregate (Redundanz mit kurzzeitiger Unterbrechung):</strong> Im Stoerfall erfolgt eine automatische Umschaltung von einem zum anderen Aggregat. Die Versorgungsunterbrechung betraegt ca. 15-20 Sekunden.</li>
                      <li><strong>Zwei oder mehrere Aggregate gleichzeitig betrieben:</strong> Im Stoerfall wird eine unterbrechungsfreie Versorgungssicherheit, durch das oder die anderen Aggregate gewaehrleistet.</li>
                    </ul>
                  </li>
                  ...
                  <li>Unsere Aggregate und Zusatztanks koennen mit HEL (Heizoel extra leicht) DIN 51 603-01 betankt werden. Das HEL muss ausreichend mit Kaelteadditiv (Sommer wie Winter) additiviert sein (bis -20°C). Damit die Kaeltesicherheit gewaehrleistet ist, muss das Kaelteadditiv vor dem Frost bei ueber 0°C zum HEL gegeben werden. Das Verwenden von nicht additiviertem Heizoel kann bei niedrigen Temperaturen zum Stillstand der Maschine fuehren. Dadurch entstehende Kosten werden dem Auftraggeber gesondert nach Aufwand berechnet.</li>
                  <li>Bei Nutzung eines externen Tanks, kann der interne Tank nur bedingt genutzt werden. (Umschaltung am 3 Wege-Kraftstoffventil nur bei Motorstillstand zulaessig). Zusaetzlich empfehlen wir Ihnen unser Winterset mit zu bestellen.</li>
                </ol>
              </div>
              ...
              <div>
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  <li>Auf- und Abbau wird durch einen Techniker der Eventenergie Deutschland GmbH & Co. KG durchgefuehrt.</li>
                  ...
                  <li>Fuer alle Bestellungen und Lieferungen unter 10 Tage gilt: Die Auslieferung zum Mietmaterial erfolgt nach Absprache und Pruefung der Verfuegbarkeit, jedoch fruehestens 8-10 Tage nach Erhalt Ihrer Bestellung. Expresslieferungen und Notfaelle muessen gesondert schriftlich vereinbart werden und gehen mit einer Erhoehung von 20% der angebotenen Mietartikel einher.</li>
                  <li><strong>GPS-Tracking:</strong> Der Vermieter weist darauf hin, dass die Mietgeraete teilweise mit einem GPS-Ortungssystem ausgeruestet sind. Die an den Vermieter bei Aktivierung uebermittelten Daten, dienen der Erfassung von technischen Betriebszustaenden des Mietgeraets.</li>
              ...
              <div>
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  <li>Der Mietgegenstand darf nur zu den vereinbarten Arbeiten und an dem vereinbarten Ort genutzt werden. Der Mieter ist ohne Zustimmung des Vermieters nicht berechtigt, den Mietgegenstand einem Dritten zu ueberlassen oder den Mietgegenstand weiter zu vermieten.</li>
                  <li>Zeigen sich Stoerungen, muss der Mieter dies dem Vermieter unverzueglich schriftlich anzeigen. Der Mieter ist nicht berechtigt, ohne Zustimmung des Vermieters Reparaturen an dem Mietgegenstand durchzufuehren. <strong>Wir weisen ausdruecklich darauf hin, dass wir keine Haftung, Ausfallkosten oder an uns gerichtete Regressansprueche uebernehmen, die durch einen Stoerfall verursacht wurden.</strong></li>
                  ...
                  <li>Die Mietobjekte sind in gleichem Zustand wie geliefert bereitzustellen. Fuer Diebstahl, Schaeden und Verunreinigungen jeglicher Art, haftet der Mieter. Gitterboxen sind entsprechend dem Auslieferungszustand gepackt zu uebergeben. Bei Missachtung behalten wir uns vor, erforderliche Arbeiten und/oder Reinigungskosten in Rechnung zu stellen.</li>
                  <li>Der Mieter ist verpflichtet, zur Abdeckung der Risiken gegen Verlust oder Beschaedigung des Mietgegenstandes eine Versicherung in Hoehe des Wiederbeschaffungswertes des Mietgegenstandes abzuschliessen und diese auf Verlangen des Vermieters nachzuweisen.</li>
                </ol>
              </div>
              ...
              <div>
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  <li>Ein Vertrag (Mietvertrag) ist abgeschlossen, wenn der Mieter den Auftrag (Angebot) schriftlich bestaetigt oder wenn ein Vertrag von den Parteien wechselseitig unterzeichnet wird.</li>
                  <li>Das Mietverhaeltnis beginnt mit dem Tag der Anlieferung (Berechnung voller Miettag). Ist bei der Auftragserteilung durch den Kunden kein Mietende angegeben (nur werktags Mo.-Do. 07:30-16:30 Uhr und Fr. 07:30 - 15:15 Uhr moeglich, samstags, sonn- und feiertags nur nach vorheriger Absprache und Mehrkostenaufwand) gilt: Freimeldungen (fuer den gleichen Werktag der Abmeldung) muessen bis spaetestens 11:00 Uhr schriftlich unserem Buero gemeldet werden. Ihre Freimeldung senden Sie bitte an: <a href="mailto:info@eventenergie-deutschland.de" className="text-blue-600 hover:underline">info@eventenergie-deutschland.de</a></li>
                  <li>Unser Mietmaterial unterliegt vor der Auslieferung einer hausinternen Werkspruefung. Weitere Pruefungen zum Mietmaterial waehrend der Mietperiode sind nicht im Mietpreis enthalten. Diese werden vom Mieter nach eigener Gefaehrdungsbeurteilung durchgefuehrt. Die Kosten traegt der Mieter. Der Mieter hat den Mietgegenstand bei Uebergabe zu pruefen.</li>
                  <li>Maengel hat der Mieter dem Vermieter unverzueglich, spaetestens jedoch einen Tag nach Uebergabe schriftlich anzuzeigen und zu ruegen. Nach Ablauf der Ruegefrist gilt der Mietgegenstand als vertragsgemaess maengelfrei uebergeben.</li>
                  <li>Das Mietmaterial unterliegt waehrend der Mietzeit der Obhutspflicht des Mieters. Der Mieter erklaert sich damit einverstanden, dass bei einem Verlust der Mietsache der aktuelle Wiederbeschaffungswert unabhaengig vom Zeitwert der Mietsache berechnet wird.</li>
                  <li>Eine Rueckverguetung der Mietsache gegenueber bereits geleisteten Zahlungen oder offenen Forderungen erfolgt nicht.</li>
                  <li>Im Stoerfall einer Mietsache stehen wir Ihnen innerhalb unserer o.a. Buerozeiten und selbstverstaendlich mit unserem 24 Stunden Service ausserhalb der Buerozeiten jederzeit unter der Nummer <strong>0171/7775543</strong> zur Verfuegung. Wir sind bemueht, schnellstmoeglich den Stoerfall zu beheben.</li>
                  <li>Eine Mietminderung erfolgt nur, wenn der Mieter den Stoerfall unverzueglich anzeigt, sich der Mietgegenstand innerhalb von Deutschland befindet und der Mangel durch uns nicht innerhalb von 24 Stunden behoben werden kann (ab Stoerfall-Meldeeingang beim Vermieter und bei nachweislichem Nichtverschulden des Mieters).</li>
                </ol>
              </div>
              ...
              <div>
                ...
                <p className="mb-2">Sofern der Mieter vor Auslieferung bzw. Beginn des Mietzeitraums vom Vertrag zuruecktritt oder den Vertrag storniert, ist der Vermieter berechtigt, folgende pauschalierten Saetze zu berechnen:</p>
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 space-y-1">
                  <div className="flex justify-between text-sm"><span>56 und laenger Tage vor Auslieferung</span><span className="font-semibold">25 %</span></div>
