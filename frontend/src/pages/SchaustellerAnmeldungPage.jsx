...
export default function SchaustellerAnmeldungPage() {
  ...
  const handleSignup = async () => {
    ...
    setSaving(true);
    try {
      // Build summary before submitting
          ...
          {step === "done" && (
            <div className="bg-white border border-gray-200 rounded-xl p-8 text-center" data-testid="done-step">
              ...
              <div className="flex flex-col gap-3">
                <Button onClick={() => { setSignupForm({ platznummer: "", fahrgeschaeft: "", connection_type: "", payment_method: "kreditkarte" }); setAdditionalSignups([]); setCompletedBookings([]); setStep("signup"); }} variant="outline" className="border-fuchsia-200 text-fuchsia-600 hover:bg-fuchsia-50" data-testid="another-signup-btn">
                  <Plus className="w-4 h-4 mr-1" /> Weiteren Stand anmelden
                </Button>
                <Button onClick={() => { loadBookings(schausteller.id); setStep("dashboard"); setSignupForm({ platznummer: "", fahrgeschaeft: "", connection_type: "", payment_method: "kreditkarte" }); setCompletedBookings([]); }} className="bg-fuchsia-600 hover:bg-fuchsia-700 text-white" data-testid="to-dashboard-btn">
