...
def load_config():
    config = {
        ...
        # v2.3.0: Hardware ist auf 19200 Baud fest umgestellt (max. supportet
        # vom RI-F100-C laut Datenblatt). Bei 19200 bleibt der Logging-Zyklus
        # mit allen 15 Reads pro Sekunde komfortabel unter der 1s-Sollzeit.
        ...
        # Modbus-Reads. Bei 19200 Baud (v2.3.0) reicht 20ms zuverlaessig - der
        # 3.5-Char-Silence ist bei 19200 nur noch ~1.8ms, der Meter braucht
        # intern aber etwas Bearbeitungszeit.
        "modbus_inter_read_delay_s": 0.02,
        # Portal
        "api_url": "",
        "device_key": "",
        "device_id": "",
...
def read_rayleigh():
    ...
    v2.3.0: Hardware ist auf 19200 Baud fest umgestellt - alle 15 Reads
    werden jede Sekunde durchgefuehrt (kein Skip-Trick mehr noetig). Der
    komplette Zyklus dauert nur noch ~0.5s.
