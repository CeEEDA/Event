...
- 2026-05-22: **Bugfix DSE Alarm-Duplikation (P2):** Pi-Script sendete den gleichen Alarm 1× pro Telemetry-Record → `fault_text` im Snapshot enthielt mehrfach denselben Text (z.B. "Generator Unterspannung, Generator Unterspannung, Generator Unterspannung"). Skript v2.0.2 dedupliziert jetzt pro Sync-Run nach `pos` (alarm_code), behält nur den juengsten Timestamp. Anzeige im UI ist jetzt 1× pro echter Alarm.
